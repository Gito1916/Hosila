...
async def get_dashboard_kpis(
    ...
    total_rev = Decimal(str(rev["total_rev"]))
    ...
    return DashboardKPIs(
        ...
        accommodation_revenue=Decimal(str(rev["accom_rev"])),
        restaurant_revenue=Decimal(str(rev["rest_rev"])),
        other_revenue=Decimal(str(rev["other_rev"])),
