...
export function CloudIntegrationsPanel() {
    ...
    return (
        <div className="space-y-3">
            <div className="mb-4">
                <h3 className="text-lg font-semibold text-white">Cloud & Integrations</h3>
                <p className="text-sm text-slate-400">Manage cloud sync, email import, and website API</p>
            </div>
            ...
            <div className="card overflow-hidden">
                ...
                >
                    ...
                    <div className="flex-1">
                        <h4 className="text-white font-medium text-sm">Cloud Sync</h4>
                        <p className="text-xs text-slate-400">Sync data across devices</p>
                    </div>
