...
export function RoomsPanel() {
    ...
    return (
        <div className="space-y-3">
            <div className="mb-4">
                <h3 className="text-lg font-semibold text-heading">Rooms</h3>
                <p className="text-sm text-muted">Manage rooms and room types</p>
            </div>
            ...
            <div className="card overflow-hidden">
                ...
                >
                    ...
                    <div className="flex-1">
                        <h4 className="text-heading font-medium text-sm">Room List</h4>
                        <p className="text-xs text-muted">Add, edit, and manage individual rooms</p>
                    </div>
            ...
            <div className="card overflow-hidden">
                ...
                >
                    ...
                    <div className="flex-1">
                        <h4 className="text-heading font-medium text-sm">Room Types</h4>
                        <p className="text-xs text-muted">Configure room categories and base rates</p>
                    </div>
